document.addEventListener("DOMContentLoaded", function () {
    ...
    setTimeout(() => {
        animatedDiv.style.animation = "bounce-in-top 0.2s both";
        animatedDiv.style.opacity = 1;
    }, 500);
    
    animatedDiv.addEventListener('animationend', (event) => {
        if (event.animationName === 'bounce-in-top') {
            animatedDiv.style.animation = "color-change-2x 0.5s linear normal";
            ...
            TextInLogo.style.animation = "text-focus-in 0.3s cubic-bezier(0.550, 0.085, 0.680, 0.530) both";
        } else if (event.animationName === 'text-focus-in') {
            SkirtInLogo.style.animation = "slide-in-blurred-bottom 0.8s cubic-bezier(0.230, 1.000, 0.320, 1.000) both";
            ...
            StartBackground.style.animation = "fade-out 0.5s ease-out both";
        }
    });
